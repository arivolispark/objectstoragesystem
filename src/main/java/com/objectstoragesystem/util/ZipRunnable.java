    ...
    public void run() {
        ...
        if (ingressFolder != null &&
            ...
            try {
                ...
                Util.upload(zipFileCanonicalPath, uploadFolder, s3ObjectUploadService);

                //Upload metadata.txt file of the hourly folder
                Util.upload(zipFolder + File.separator + METADATA_TXT_FILE_NAME, uploadFolder, s3ObjectUploadService);
